function createAgentRuntime({ settings, bridge, onLog = () => {}, onRecovery = () => {}, onCheckpoint = () => {}, onState = () => {}, onProgress = () => {}, onStepEvent = () => {}, deps = {} }) {
  ...
  async function run(goal, resume) {
    ...
    try {
      ...
      const result = await executor.execute(planDoc, {
        llm, bridge, memory, notes, onLog, onRecovery, onCheckpoint, onProgress, onStepEvent,
